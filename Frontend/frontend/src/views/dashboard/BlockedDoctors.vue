<template>
  <div class="container">
    <h2 class="mb-4 text-center text-primary fw-bold">Blocked Doctors</h2>

    <div v-if="loading" class="text-center mt-5">
      <div class="spinner-border text-primary"></div>
      <p class="mt-3">Loading blocked doctors...</p>
    </div>
      ...
      >
        <div class="user-card shadow-lg">
          <div class="card-header-area">
            ...
            <h5 class="user-name">{{ doctor.username }}</h5>
          ...
          <div class="action-buttons mt-3">
            <button class="btn unblock-btn" @click="unblockUser(doctor)"> Unblock</button>
          </div>
        </div>
      </div>
    </div>
